...
def exp(rv):
    rotationAxis = normalized(rv)
    theta = rv[0]/rotationAxis[0]

    return getRotMatFrom(rotationAxis , theta)
...
# from here , 4 interpolation functions
def slerp(R1, R2, t):
    slerpArray = R1 @ exp(t * log(np.transpose(R1) @ R2))
    return slerpArray
...
def interpolateZYXEuler(euler1, euler2, t):
    euler3 = np.array([lerp(euler1[0], euler2[0],t), lerp(euler1[1], euler2[1],t), lerp(euler1[2], euler2[2],t)])
    return ZYXEulerToRotMat(euler3)

def interpolateRotMat(R1, R2, t):
    nm = np.array([[lerp(R1[0][0], R2[0][0], t), lerp(R1[0][1], R2[0][1], t), lerp(R1[0][2], R2[0][2], t)],
                 [lerp(R1[1][0], R2[1][0], t), lerp(R1[1][1], R2[1][1], t), lerp(R1[1][2], R2[1][2], t)],
                 [lerp(R1[2][0], R2[2][0], t), lerp(R1[2][1], R2[2][1], t), lerp(R1[2][2], R2[2][2], t)]])
